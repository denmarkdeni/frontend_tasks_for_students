...
const tasks = [
  {
    ...
    category: "HTML",
    topics: ["Semantic Tags", "Headings", "Paragraphs", "Lists", "Links", "Images"],
  },
  {
    id: 2,
    number: "02",
    title: "CSS Styling",
    category: "CSS",
    topics: ["Selectors", "Box Model", "Colors", "Fonts", "Borders", "Padding & Margin"],
  },
  {
    id: 3,
    number: "03",
    ...
    category: "CSS",
    topics: ["display: flex", "flex-direction", "justify-content", "align-items", "gap", "flex-wrap"],
  },
  {
    id: 4,
    number: "04",
